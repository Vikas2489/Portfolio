        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Led the development of an e-commerce website using the MERN stack (MongoDB, Express.js, React.js, Node.js), currently in the production phase. Enhanced user experience with product category management and Elastic Search for fast searches. Set up a Digital Ocean VM, implemented SEO strategies, integrated a secure payment gateway, and configured Nginx with SSL. Added voice search functionality for hands-free use, showcasing expertise in comprehensive e-commerce solutions."
